...
python read_fasta2_plasmids.py  -i $FASTA -o $OUT/$DATETIME.$FASTA 
...
python format_Test.py  --inputfasta $FASTA --inputyml $OUT/$DATETIME.$FASTA/yml --dataPath $OUT/dlDataPath
...
python predict_Plasmid.py --dataPath $OUT/dlDataPath  --given test  --kModelList  20-29  --dataSegment -1  --seedModel  models/plasmid4g-
